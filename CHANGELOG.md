...
- **data**: Add receipt to the data module
  ([#1877](https://github.com/canvas-medical/canvas-plugins/pull/1877),
  [`7cbd4e1`](https://github.com/canvas-medical/canvas-plugins/commit/7cbd4e17393d9b99001d7fcce70cfc26312b9b70))
...
- **data**: Add cancel prescription response to the data module
  ([#1862](https://github.com/canvas-medical/canvas-plugins/pull/1862),
  [`8a61e36`](https://github.com/canvas-medical/canvas-plugins/commit/8a61e36a21a4543358d3f473279690f242029ede))
...
- Add optional id to allergy and update goal command ids
  ...
  [`80b8a94`](https://github.com/canvas-medical/canvas-plugins/commit/80b8a94a0cead34a508e9f8d6ed500171f4dac96))
