...
class EffectType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    DELEGATE_REFER_COMMAND: _ClassVar[EffectType]
    SIGN_REFER_COMMAND: _ClassVar[EffectType]
    ...
    CREATE_QUESTIONNAIRE: _ClassVar[EffectType]
    ANNOTATE_PATIENT_CHART_CONDITION_RESULTS: _ClassVar[EffectType]
    ANNOTATE_PATIENT_CHART_DETECTED_ISSUE_RESULTS: _ClassVar[EffectType]
    ...
    PHONE_DIAL__CONFIGURATION: _ClassVar[EffectType]
    ...
    DELEGATE_IMAGING_ORDER_COMMAND: _ClassVar[EffectType]
    SIGN_IMAGING_ORDER_COMMAND: _ClassVar[EffectType]
    ...
    ORIGINATE_LAB_REVIEW_COMMAND: _ClassVar[EffectType]
    EDIT_LAB_REVIEW_COMMAND: _ClassVar[EffectType]
    DELETE_LAB_REVIEW_COMMAND: _ClassVar[EffectType]
    COMMIT_LAB_REVIEW_COMMAND: _ClassVar[EffectType]
    ENTER_IN_ERROR_LAB_REVIEW_COMMAND: _ClassVar[EffectType]
    ORIGINATE_IMAGING_REVIEW_COMMAND: _ClassVar[EffectType]
    EDIT_IMAGING_REVIEW_COMMAND: _ClassVar[EffectType]
    DELETE_IMAGING_REVIEW_COMMAND: _ClassVar[EffectType]
    COMMIT_IMAGING_REVIEW_COMMAND: _ClassVar[EffectType]
    ENTER_IN_ERROR_IMAGING_REVIEW_COMMAND: _ClassVar[EffectType]
    ORIGINATE_REFERRAL_REVIEW_COMMAND: _ClassVar[EffectType]
    EDIT_REFERRAL_REVIEW_COMMAND: _ClassVar[EffectType]
    DELETE_REFERRAL_REVIEW_COMMAND: _ClassVar[EffectType]
    COMMIT_REFERRAL_REVIEW_COMMAND: _ClassVar[EffectType]
    ENTER_IN_ERROR_REFERRAL_REVIEW_COMMAND: _ClassVar[EffectType]
    ORIGINATE_UNCATEGORIZED_DOCUMENT_REVIEW_COMMAND: _ClassVar[EffectType]
    EDIT_UNCATEGORIZED_DOCUMENT_REVIEW_COMMAND: _ClassVar[EffectType]
    DELETE_UNCATEGORIZED_DOCUMENT_REVIEW_COMMAND: _ClassVar[EffectType]
    COMMIT_UNCATEGORIZED_DOCUMENT_REVIEW_COMMAND: _ClassVar[EffectType]
    ENTER_IN_ERROR_UNCATEGORIZED_DOCUMENT_REVIEW_COMMAND: _ClassVar[EffectType]
    ORIGINATE_POC_LAB_TEST_COMMAND: _ClassVar[EffectType]
    EDIT_POC_LAB_TEST_COMMAND: _ClassVar[EffectType]
    DELETE_POC_LAB_TEST_COMMAND: _ClassVar[EffectType]
    COMMIT_POC_LAB_TEST_COMMAND: _ClassVar[EffectType]
    ENTER_IN_ERROR_POC_LAB_TEST_COMMAND: _ClassVar[EffectType]
    ORIGINATE_REFERENCE_COMMAND: _ClassVar[EffectType]
    EDIT_REFERENCE_COMMAND: _ClassVar[EffectType]
    DELETE_REFERENCE_COMMAND: _ClassVar[EffectType]
    COMMIT_REFERENCE_COMMAND: _ClassVar[EffectType]
    ENTER_IN_ERROR_REFERENCE_COMMAND: _ClassVar[EffectType]
    ORIGINATE_IMMUNIZE_COMMAND: _ClassVar[EffectType]
    EDIT_IMMUNIZE_COMMAND: _ClassVar[EffectType]
    DELETE_IMMUNIZE_COMMAND: _ClassVar[EffectType]
    COMMIT_IMMUNIZE_COMMAND: _ClassVar[EffectType]
    ENTER_IN_ERROR_IMMUNIZE_COMMAND: _ClassVar[EffectType]
    ORIGINATE_ADD_CONDITION_COMMAND: _ClassVar[EffectType]
    EDIT_ADD_CONDITION_COMMAND: _ClassVar[EffectType]
    DELETE_ADD_CONDITION_COMMAND: _ClassVar[EffectType]
    COMMIT_ADD_CONDITION_COMMAND: _ClassVar[EffectType]
    ENTER_IN_ERROR_ADD_CONDITION_COMMAND: _ClassVar[EffectType]
    ORIGINATE_REMOVE_PAST_MEDICAL_HISTORY_COMMAND: _ClassVar[EffectType]
    EDIT_REMOVE_PAST_MEDICAL_HISTORY_COMMAND: _ClassVar[EffectType]
    DELETE_REMOVE_PAST_MEDICAL_HISTORY_COMMAND: _ClassVar[EffectType]
    COMMIT_REMOVE_PAST_MEDICAL_HISTORY_COMMAND: _ClassVar[EffectType]
    ENTER_IN_ERROR_REMOVE_PAST_MEDICAL_HISTORY_COMMAND: _ClassVar[EffectType]
    ...
    PATIENT_PORTAL__SEND_CONTACT_VERIFICATION: _ClassVar[EffectType]
    ...
    CHECK_IN_NOTE: _ClassVar[EffectType]
    NO_SHOW_NOTE: _ClassVar[EffectType]
    DELETE_NOTE: _ClassVar[EffectType]
    UNDELETE_NOTE: _ClassVar[EffectType]
    DISCHARGE_NOTE: _ClassVar[EffectType]
    REVERT_APPOINTMENT: _ClassVar[EffectType]
    ...
    CREATE_OBSERVATION: _ClassVar[EffectType]
    UPDATE_OBSERVATION: _ClassVar[EffectType]
    ENTER_IN_ERROR_OBSERVATION: _ClassVar[EffectType]
    PATIENT_CHART__GROUP_ITEMS: _ClassVar[EffectType]
    PATIENT_CHART_SUMMARY__CUSTOM_SECTION: _ClassVar[EffectType]
    PATIENT_CHART__CONFIGURE_COMMAND_BUTTONS: _ClassVar[EffectType]
    APPOINTMENT__FORM__PROVIDERS__PRE_SEARCH_RESULTS: _ClassVar[EffectType]
    APPOINTMENT__FORM__LOCATIONS__PRE_SEARCH_RESULTS: _ClassVar[EffectType]
    APPOINTMENT__FORM__VISIT_TYPES__PRE_SEARCH_RESULTS: _ClassVar[EffectType]
    APPOINTMENT__FORM__DURATIONS__PRE_SEARCH_RESULTS: _ClassVar[EffectType]
    APPOINTMENT__FORM__REASON_FOR_VISIT__PRE_SEARCH_RESULTS: _ClassVar[EffectType]
    APPOINTMENT__FORM__PROVIDERS__POST_SEARCH_RESULTS: _ClassVar[EffectType]
    APPOINTMENT__FORM__LOCATIONS__POST_SEARCH_RESULTS: _ClassVar[EffectType]
    APPOINTMENT__FORM__VISIT_TYPES__POST_SEARCH_RESULTS: _ClassVar[EffectType]
    APPOINTMENT__FORM__DURATIONS__POST_SEARCH_RESULTS: _ClassVar[EffectType]
    APPOINTMENT__FORM__REASON_FOR_VISIT__POST_SEARCH_RESULTS: _ClassVar[EffectType]
    ...
    REVENUE__PAYMENT_PROCESSOR__PAYMENT_METHOD: _ClassVar[EffectType]
    ...
    CREATE_PATIENT_IDENTIFICATION_CARD: _ClassVar[EffectType]
    UPDATE_PATIENT_IDENTIFICATION_CARD: _ClassVar[EffectType]
    DELETE_PATIENT_IDENTIFICATION_CARD: _ClassVar[EffectType]
    ORIGINATE_VISUAL_EXAM_FINDING_COMMAND: _ClassVar[EffectType]
    EDIT_VISUAL_EXAM_FINDING_COMMAND: _ClassVar[EffectType]
    DELETE_VISUAL_EXAM_FINDING_COMMAND: _ClassVar[EffectType]
    COMMIT_VISUAL_EXAM_FINDING_COMMAND: _ClassVar[EffectType]
    ENTER_IN_ERROR_VISUAL_EXAM_FINDING_COMMAND: _ClassVar[EffectType]
...
DELEGATE_REFER_COMMAND: EffectType
SIGN_REFER_COMMAND: EffectType
...
CREATE_QUESTIONNAIRE: EffectType
ANNOTATE_PATIENT_CHART_CONDITION_RESULTS: EffectType
ANNOTATE_PATIENT_CHART_DETECTED_ISSUE_RESULTS: EffectType
...
PHONE_DIAL__CONFIGURATION: EffectType
...
DELEGATE_IMAGING_ORDER_COMMAND: EffectType
SIGN_IMAGING_ORDER_COMMAND: EffectType
...
ORIGINATE_LAB_REVIEW_COMMAND: EffectType
EDIT_LAB_REVIEW_COMMAND: EffectType
DELETE_LAB_REVIEW_COMMAND: EffectType
COMMIT_LAB_REVIEW_COMMAND: EffectType
ENTER_IN_ERROR_LAB_REVIEW_COMMAND: EffectType
ORIGINATE_IMAGING_REVIEW_COMMAND: EffectType
EDIT_IMAGING_REVIEW_COMMAND: EffectType
DELETE_IMAGING_REVIEW_COMMAND: EffectType
COMMIT_IMAGING_REVIEW_COMMAND: EffectType
ENTER_IN_ERROR_IMAGING_REVIEW_COMMAND: EffectType
ORIGINATE_REFERRAL_REVIEW_COMMAND: EffectType
EDIT_REFERRAL_REVIEW_COMMAND: EffectType
DELETE_REFERRAL_REVIEW_COMMAND: EffectType
COMMIT_REFERRAL_REVIEW_COMMAND: EffectType
ENTER_IN_ERROR_REFERRAL_REVIEW_COMMAND: EffectType
ORIGINATE_UNCATEGORIZED_DOCUMENT_REVIEW_COMMAND: EffectType
EDIT_UNCATEGORIZED_DOCUMENT_REVIEW_COMMAND: EffectType
DELETE_UNCATEGORIZED_DOCUMENT_REVIEW_COMMAND: EffectType
COMMIT_UNCATEGORIZED_DOCUMENT_REVIEW_COMMAND: EffectType
ENTER_IN_ERROR_UNCATEGORIZED_DOCUMENT_REVIEW_COMMAND: EffectType
ORIGINATE_POC_LAB_TEST_COMMAND: EffectType
EDIT_POC_LAB_TEST_COMMAND: EffectType
DELETE_POC_LAB_TEST_COMMAND: EffectType
COMMIT_POC_LAB_TEST_COMMAND: EffectType
ENTER_IN_ERROR_POC_LAB_TEST_COMMAND: EffectType
ORIGINATE_REFERENCE_COMMAND: EffectType
EDIT_REFERENCE_COMMAND: EffectType
DELETE_REFERENCE_COMMAND: EffectType
COMMIT_REFERENCE_COMMAND: EffectType
ENTER_IN_ERROR_REFERENCE_COMMAND: EffectType
ORIGINATE_IMMUNIZE_COMMAND: EffectType
EDIT_IMMUNIZE_COMMAND: EffectType
DELETE_IMMUNIZE_COMMAND: EffectType
COMMIT_IMMUNIZE_COMMAND: EffectType
ENTER_IN_ERROR_IMMUNIZE_COMMAND: EffectType
ORIGINATE_ADD_CONDITION_COMMAND: EffectType
EDIT_ADD_CONDITION_COMMAND: EffectType
DELETE_ADD_CONDITION_COMMAND: EffectType
COMMIT_ADD_CONDITION_COMMAND: EffectType
ENTER_IN_ERROR_ADD_CONDITION_COMMAND: EffectType
ORIGINATE_REMOVE_PAST_MEDICAL_HISTORY_COMMAND: EffectType
EDIT_REMOVE_PAST_MEDICAL_HISTORY_COMMAND: EffectType
DELETE_REMOVE_PAST_MEDICAL_HISTORY_COMMAND: EffectType
COMMIT_REMOVE_PAST_MEDICAL_HISTORY_COMMAND: EffectType
ENTER_IN_ERROR_REMOVE_PAST_MEDICAL_HISTORY_COMMAND: EffectType
...
PATIENT_PORTAL__SEND_CONTACT_VERIFICATION: EffectType
...
CHECK_IN_NOTE: EffectType
NO_SHOW_NOTE: EffectType
DELETE_NOTE: EffectType
UNDELETE_NOTE: EffectType
DISCHARGE_NOTE: EffectType
REVERT_APPOINTMENT: EffectType
...
CREATE_OBSERVATION: EffectType
UPDATE_OBSERVATION: EffectType
ENTER_IN_ERROR_OBSERVATION: EffectType
PATIENT_CHART__GROUP_ITEMS: EffectType
PATIENT_CHART_SUMMARY__CUSTOM_SECTION: EffectType
PATIENT_CHART__CONFIGURE_COMMAND_BUTTONS: EffectType
APPOINTMENT__FORM__PROVIDERS__PRE_SEARCH_RESULTS: EffectType
APPOINTMENT__FORM__LOCATIONS__PRE_SEARCH_RESULTS: EffectType
APPOINTMENT__FORM__VISIT_TYPES__PRE_SEARCH_RESULTS: EffectType
APPOINTMENT__FORM__DURATIONS__PRE_SEARCH_RESULTS: EffectType
APPOINTMENT__FORM__REASON_FOR_VISIT__PRE_SEARCH_RESULTS: EffectType
APPOINTMENT__FORM__PROVIDERS__POST_SEARCH_RESULTS: EffectType
APPOINTMENT__FORM__LOCATIONS__POST_SEARCH_RESULTS: EffectType
APPOINTMENT__FORM__VISIT_TYPES__POST_SEARCH_RESULTS: EffectType
APPOINTMENT__FORM__DURATIONS__POST_SEARCH_RESULTS: EffectType
APPOINTMENT__FORM__REASON_FOR_VISIT__POST_SEARCH_RESULTS: EffectType
...
REVENUE__PAYMENT_PROCESSOR__PAYMENT_METHOD: EffectType
...
CREATE_PATIENT_IDENTIFICATION_CARD: EffectType
UPDATE_PATIENT_IDENTIFICATION_CARD: EffectType
DELETE_PATIENT_IDENTIFICATION_CARD: EffectType
ORIGINATE_VISUAL_EXAM_FINDING_COMMAND: EffectType
EDIT_VISUAL_EXAM_FINDING_COMMAND: EffectType
DELETE_VISUAL_EXAM_FINDING_COMMAND: EffectType
COMMIT_VISUAL_EXAM_FINDING_COMMAND: EffectType
ENTER_IN_ERROR_VISUAL_EXAM_FINDING_COMMAND: EffectType
