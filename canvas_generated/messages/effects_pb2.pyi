...
class EffectType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    APPOINTMENTS__FORM__PROVIDERS__PRE_SEARCH_RESULTS: _ClassVar[EffectType]
    APPOINTMENTS__FORM__LOCATIONS__PRE_SEARCH_RESULTS: _ClassVar[EffectType]
    APPOINTMENTS__FORM__VISIT_TYPES__PRE_SEARCH_RESULTS: _ClassVar[EffectType]
    APPOINTMENTS__FORM__DURATIONS__PRE_SEARCH_RESULTS: _ClassVar[EffectType]
    APPOINTMENTS__FORM__REASON_FOR_VISIT__PRE_SEARCH_RESULTS: _ClassVar[EffectType]
    APPOINTMENTS__FORM__ADDITIONAL_FIELDS__PRE_SEARCH_RESULTS: _ClassVar[EffectType]
    APPOINTMENTS__FORM__PROVIDERS__POST_SEARCH_RESULTS: _ClassVar[EffectType]
    APPOINTMENTS__FORM__LOCATIONS__POST_SEARCH_RESULTS: _ClassVar[EffectType]
    APPOINTMENTS__FORM__VISIT_TYPES__POST_SEARCH_RESULTS: _ClassVar[EffectType]
    APPOINTMENTS__FORM__DURATIONS__POST_SEARCH_RESULTS: _ClassVar[EffectType]
    APPOINTMENTS__FORM__REASON_FOR_VISIT__POST_SEARCH_RESULTS: _ClassVar[EffectType]
    APPOINTMENTS__FORM__ADDITIONAL_FIELDS__POST_SEARCH_RESULTS: _ClassVar[EffectType]
...
APPOINTMENTS__FORM__PROVIDERS__PRE_SEARCH_RESULTS: EffectType
APPOINTMENTS__FORM__LOCATIONS__PRE_SEARCH_RESULTS: EffectType
APPOINTMENTS__FORM__VISIT_TYPES__PRE_SEARCH_RESULTS: EffectType
APPOINTMENTS__FORM__DURATIONS__PRE_SEARCH_RESULTS: EffectType
APPOINTMENTS__FORM__REASON_FOR_VISIT__PRE_SEARCH_RESULTS: EffectType
APPOINTMENTS__FORM__ADDITIONAL_FIELDS__PRE_SEARCH_RESULTS: EffectType
APPOINTMENTS__FORM__PROVIDERS__POST_SEARCH_RESULTS: EffectType
APPOINTMENTS__FORM__LOCATIONS__POST_SEARCH_RESULTS: EffectType
APPOINTMENTS__FORM__VISIT_TYPES__POST_SEARCH_RESULTS: EffectType
APPOINTMENTS__FORM__DURATIONS__POST_SEARCH_RESULTS: EffectType
APPOINTMENTS__FORM__REASON_FOR_VISIT__POST_SEARCH_RESULTS: EffectType
APPOINTMENTS__FORM__ADDITIONAL_FIELDS__POST_SEARCH_RESULTS: EffectType
