...
class Protocol(BaseProtocol):
    ...
    def compute(self) -> list[Effect]:
        ...
        if normalized_priority == urgent_value:
            ...
            log.info("OVDE VRACA ADD BANNER? 1")
        ...
        log.info("OVDE VRACA REMOVE BANNER? 1")
