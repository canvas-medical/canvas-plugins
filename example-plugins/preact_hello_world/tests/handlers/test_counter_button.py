...
from preact_hello_world.handlers.counter_button import CounterButton
...
@patch("preact_hello_world.handlers.counter_button.render_to_string", return_value=COUNTER_HTML)
