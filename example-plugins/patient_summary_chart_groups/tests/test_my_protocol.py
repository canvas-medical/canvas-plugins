...
class TestConditionsGrouping:
    ...
    def test_groups_psychiatric_conditions_f_codes(self) -> None:
        ...
        mock_event.context = [
            {
                ...
                "codings": [{"system": CodeSystems.ICD10, "code": "F32.9"}],
            },
            {
                "id": "condition-2",
                "display": "Generalized anxiety disorder",
                "codings": [{"system": CodeSystems.ICD10, "code": "F41.1"}],
            },
        ]
    ...
    def test_groups_psychiatric_conditions_r45_codes(self) -> None:
        ...
        mock_event.context = [
            {
                "id": "condition-1",
                "display": "Nervousness",
                "codings": [{"system": CodeSystems.ICD10, "code": "R45.0"}],
            }
        ]
    ...
    def test_does_not_group_non_psychiatric_conditions(self) -> None:
        ...
        mock_event.context = [
            {
                ...
                "codings": [{"system": CodeSystems.ICD10, "code": "I10"}],
            },
            {
                "id": "condition-2",
                "display": "Type 2 diabetes",
                "codings": [{"system": CodeSystems.ICD10, "code": "E11.9"}],
            },
        ]
    ...
    def test_handles_mixed_conditions(self) -> None:
    ...
    def test_handles_empty_conditions_list(self) -> None:
    ...
    def test_handles_condition_with_multiple_codings(self) -> None:
...
class TestMedicationsGrouping:
    ...
    def test_groups_psychiatric_medications(self) -> None:
    ...
    def test_does_not_group_non_psychiatric_medications(self) -> None:
    ...
    def test_handles_mixed_medications(self) -> None:
        ...
        mock_event.context = [
            {
                "id": "medication-1",
                "display": "Sertraline 50mg",
                "codings": [{"system": CodeSystems.RXNORM, "code": "725"}],
            },
            {
                "id": "medication-2",
                "display": "Lisinopril 10mg",
                "codings": [{"system": CodeSystems.RXNORM, "code": "314076"}],
            },
        ]
    ...
    def test_handles_empty_medications_list(self) -> None:
    ...
    def test_handles_medication_with_multiple_codings(self) -> None:
    ...
    def test_medication_codes_list_is_populated(self) -> None:
