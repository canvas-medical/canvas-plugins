...
class CreateQuestionnaireAPI(SimpleAPIRoute):
    ...
    def post(self) -> list[Response | Effect]:
        ...
        try:
            ...
            # apply() validates the configuration, so a questionnaire the schema rejects is
            # reported here rather than failing on the Canvas side where the caller cannot see it.
