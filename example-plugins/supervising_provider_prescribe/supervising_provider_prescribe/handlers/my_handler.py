...
class Handler(BaseHandler):
    """
    This handler responds to the PRESCRIBE_COMMAND__POST_ORIGINATE event.

    It is used to test whether the supervising provider field is automatically populated
    when the Prescribe command is triggered. The handler reacts to the command's creation
