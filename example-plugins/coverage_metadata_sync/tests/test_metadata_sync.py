...
from coverage_metadata_sync.handlers.metadata_sync import CoverageStatusSyncHandler
...
class TestCoverageStatusSyncHandler:
    """Tests for the CoverageStatusSyncHandler."""
    ...
    def test_compute_label_added_missing_coverage(self, monkeypatch: MonkeyPatch) -> None:
        ...
        handler = CoverageStatusSyncHandler(event=MagicMock())
        handler.event.type = EventType.APPOINTMENT_LABEL_ADDED
    ...
    def test_compute_label_removed_missing_coverage(self, monkeypatch: MonkeyPatch) -> None:
        ...
        # Create handler instance
        handler = CoverageStatusSyncHandler(event=MagicMock())
        handler.event.type = EventType.APPOINTMENT_LABEL_REMOVED
    ...
    def test_compute_with_unexpected_event_type(self, monkeypatch: MonkeyPatch) -> None:
        ...
        handler.event.type = EventType.COVERAGE_CREATED  # Not a label event type
