"""Tests for supervising_provider_plugin.handlers.my_handler module."""

import json
from unittest.mock import MagicMock, patch

from supervising_provider_plugin.handlers.my_handler import Handler
...
class TestHandler:
    ...
    def test_responds_to_configuration(self):
        ...
        assert Handler.RESPONDS_TO == expected_events
    ...
    def test_narrative_string(self):
        ...
        assert (
            Handler.NARRATIVE_STRING
            == "I was inserted from my supervising provider plugin's handler."
        )
    ...
    def test_compute_adds_spi_annotations(self, monkeypatch):
        ...
        with patch("supervising_provider_plugin.handlers.my_handler.Staff.objects.get") as mock_get:
