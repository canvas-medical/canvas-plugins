...
class RefillTaskPriorityHandler(BaseHandler):
    ...
    def update_task_priority_command(self) -> list[Effect]:
        ...
        return self._update_priority_if_needed(
            current_priority=current_priority, team=team, use_command=True
        )
    ...
    def update_task_priority(self) -> list[Effect]:
        ...
        return self._update_priority_if_needed(
            current_priority=task.priority, team=task.team, use_command=False
        )

    def _update_priority_if_needed(
        self, current_priority: str | None, team: Team | None, use_command: bool
    ) -> list[Effect]:
        """
        ...
        log.info(
            f"Current priority: {current_priority}, Desired priority: {desired_priority_value}"
        )
    ...
    def _get_desired_priority(self, team: Team | None) -> TaskPriority | None:
        ...
        if (
            ...
            and TeamResponsibility.PROCESS_REFILL_REQUESTS in team.responsibilities
        ):
