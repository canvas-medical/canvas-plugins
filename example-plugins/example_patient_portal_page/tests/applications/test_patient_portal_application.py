"""Tests for example_patient_portal_page.applications.my_application module."""

from unittest.mock import MagicMock, patch

from example_patient_portal_page.applications.my_application import MyApplication
...
class TestMyApplication:
    ...
    def test_on_open_returns_launch_modal_effect(self):
        ...
        with patch(
            "example_patient_portal_page.applications.my_application.LaunchModalEffect"
        ) as mock_effect:
