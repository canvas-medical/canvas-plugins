...
class BaseModal:
    ...
    def create_modal(
        ...
        full_content = render_to_string(
            "templates/modals/base_modal_wrapper.html",
            {"css_variables": self._get_css_variables(), "content": content},
        )
    ...
    def create_section(self, content: str, style_type: str = "neutral") -> str:
        ...
        return render_to_string(
            "templates/components/modal_section.html",
            {
                "content": content,
    ...
    def create_title(self, text: str, level: int = 3, color: str = "var(--text)") -> str:
        ...
        return render_to_string(
            "templates/components/modal_title.html",
            {
                "text": text,
                "level": level,
                "color": color,
    ...
    def create_info_box(self, title: str, items: list[str], icon: str = "ℹ️") -> str:
        ...
        return render_to_string(
            "templates/components/info_box.html",
            {
                "title": title,
                "items": items,
                "icon": icon,
    ...
    def create_error_box(self, title: str, errors: list[str], icon: str = "❌") -> str:
        ...
        return render_to_string(
            "templates/components/error_box.html",
            {
                "title": title,
                "errors": errors,
                "icon": icon,
