...
class DTOToXMLConverter:
    ...
    def convert_to_xml_format(self, extracted_data: dict) -> dict:
        ...
        return {
            ...
            'practice_location': self._convert_practice_location_dto(extracted_data.get('practice_location')),
    ...
    def _convert_organization_dto(self, organization_dto) -> Dict[str, Any]:
        ...
        return {
            ...
            # 'practice_location': self._convert_practice_location_dto(organization_dto.practice_location)
        }
