...
class AuthHandler:
    ...
    def create_auth_headers(self, secrets: Dict[str, str], use_test_env: bool = False) -> Dict[str, str]:
        """
        ...
        log.info(f"AuthHandler: Creating PMP Gateway authentication headers for {env_label} environment")
