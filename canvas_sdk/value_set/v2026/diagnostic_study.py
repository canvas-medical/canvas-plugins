...
class ImagingRelatedToVte(ValueSet):
    ...
    **Inclusion Criteria:** Imaging code related to VTE

    **Exclusion Criteria:** N/A
    """

    VALUE_SET_NAME = "Imaging Related to VTE"
    OID = "2.16.840.1.113762.1.4.1206.47"
    DEFINITION_VERSION = "20230105"
...
class Mammography(ValueSet):
    ...
    **Exclusion Criteria:** Excludes order only codes.
    ...
    LOINC = {
        "103885-0",  # MG Breast - left Screening for implant
        "103886-8",  # MG Breast - right Screening for implant
        "103892-6",  # DBT Breast screening
        "103893-4",  # MG Breast Screening for implant
        "103894-2",  # MG Breast Diagnostic for implant
...
class EjectionFraction(ValueSet):
    ...
    **Exclusion Criteria:** No exclusions.
    ...
    LOINC = {
        ...
        "104145-8",  # Left ventricular Ejection fraction - upper limit by US.2D.A2C+Estimated
        "104146-6",  # Left ventricular Ejection fraction - upper limit by US.2D.A3C+Estimated
        "104147-4",  # Left ventricular Ejection fraction - upper limit by US.3D.A3C+Estimated
        "104148-2",  # Left ventricular Ejection fraction - upper limit by US.3D.A4C+Estimated
        "104149-0",  # Left ventricular Ejection fraction by US.2D.A2C+Calculated by biplane method
        "104150-8",  # Left ventricular Ejection fraction by US.2D.A3C+Calculated by biplane method
        "104151-6",  # Left ventricular Ejection fraction by US.2D.A4C+Calculed by biplane method
        "104152-4",  # Left ventricular Ejection fraction by US.3D.A2C+Calculated by biplane method
        "104153-2",  # Left ventricular Ejection fraction by US.3D.A3C+Calculated by biplane method
        "104154-0",  # Left ventricular Ejection fraction by US.3D.A4C+Calculated by biplane method
        "104155-7",  # Left ventricular Ejection fraction - upper limit by US.3D.A2C+Estimated
        "104157-3",  # Left ventricular Ejection fraction - upper limit by US.2D.A4C+Estimated
        "104243-1",  # Left ventricular Ejection fraction - lower limit by US.2D.A3C+Estimated
        "104244-9",  # Left ventricular Ejection fraction - lower limit by US.2D.A4C+Estimated
        "104245-6",  # Left ventricular Ejection fraction - lower limit by US.3D.A2C+Estimated
        "104246-4",  # Left ventricular Ejection fraction - lower limit by US.3D.A3C+Estimated
        "104247-2",  # Left ventricular Ejection fraction - lower limit by US.3D.A4C+Estimated
        "104251-4",  # Left ventricular Ejection fraction by US.2D.A2C+Estimated
        "104252-2",  # Left ventricular Ejection fraction by US.2D.A3C+Estimated
        "104253-0",  # Left ventricular Ejection fraction by US.2D.A4C Estimated
        "104254-8",  # Left ventricular Ejection fraction by US.3D.A2C+Estimated
        "104255-5",  # Left ventricular Ejection fraction by US.3D.A3C+Estimated
        "104256-3",  # Left ventricular Ejection fraction by US.3D.A4C+Estimated
        "104258-9",  # Left ventricular Ejection fraction - lower limit by US.2D.A2C+Estimated
...
class DiagnosticStudiesDuringPregnancy(ValueSet):
    ...
    **Exclusion Criteria:** Excludes order only codes.
    ...
    LOINC = {
        ...
        "11633-5",  # Fetal Heart rate reactivity US
...
class XrayStudy(ValueSet):
    ...
    **Exclusion Criteria:** Excludes order only codes.
    ...
    LOINC = {
        ...
        "42402-8",  # XR Unspecified body region Post mortem Views
        ...
        "96916-2",  # CT Average diameter on axial mid-scan image
        "96917-0",  # CT Average diameter on frontal scout image
...
class DexaBoneDensityForUrologyCare(ValueSet):
    ...
    **Exclusion Criteria:** No Exclusions.
    ...
    VALUE_SET_NAME = "DEXA Bone Density for Urology Care"
    OID = "2.16.840.1.113762.1.4.1248.359"
    DEFINITION_VERSION = "20250312"
    EXPANSION_VERSION = "eCQM Update 2025-05-08"

    LOINC = {
        "104938-6",  # DXA Spine [T-score] Bone density
        ...
        "80932-7",  # DXA Radius and Ulna [Z-score] Bone density
        "80933-5",  # DXA Hip [Z-score] Bone density
        "80935-0",  # DXA Radius and Ulna - right [Z-score] Bone density
        "80936-8",  # DXA Radius and Ulna - left [Z-score] Bone density
        "80937-6",  # DXA Hip - right [Z-score] Bone density
        "80938-4",  # DXA Hip - left [Z-score] Bone density
        "80943-4",  # DXA Radius and Ulna - right [T-score] Bone density
        "80944-2",  # DXA Radius and Ulna - left [T-score] Bone density
        "80945-9",  # DXA Hip - right [T-score] Bone density
        "80946-7",  # DXA Hip - left [T-score] Bone density
        "80951-7",  # DXA Radius and Ulna - right [Mass/Area] Bone density
