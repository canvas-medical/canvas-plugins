...
class NoteType(models.Model):
    ...
    category = models.CharField(choices=NoteTypeCategories)
    ...
    available_places_of_service = ArrayField(models.CharField(choices=PracticeLocationPOS))
    default_place_of_service = models.CharField(choices=PracticeLocationPOS)
...
class Note(models.Model):
    ...
    note_type = models.CharField(choices=NoteType, null=True)
