...
class LabReport(TimestampedModel, IdentifiableModel):
...
class LabReview(TimestampedModel, IdentifiableModel):
...
class LabOrder(TimestampedModel, IdentifiableModel):
...
class LabOrderReason(TimestampedModel):
