...
from canvas_sdk.clients.twillio.constants.constants import _Constants
from canvas_sdk.clients.twillio.constants.http_method import HttpMethod
from canvas_sdk.clients.twillio.structures.twi_ml_message import TwiMlMessage
...
def test_to_xml__truncates_long_message(
    ...
    with patch("canvas_sdk.clients.twillio.structures.twi_ml_message.Constants", mock_constants):
        result = twi_ml_message.to_xml()
