...
@pytest.mark.parametrize(
    ...
    [
        ...
        (TaskCommand, None),
        (ReferCommand, TaskPriority.URGENT),
        (ReferCommand, TaskPriority.STAT),
        (ReferCommand, TaskPriority.ROUTINE),
        (ReferCommand, None),
        (ImagingOrderCommand, TaskPriority.ROUTINE),
        (ImagingOrderCommand, TaskPriority.STAT),
        (ImagingOrderCommand, TaskPriority.URGENT),
