...
class TestCreateProtocolInstance:
    """Tests for create_protocol_instance helper."""

    def test_create_protocol_instance_default_timeframe(self) -> None:
    ...
    def test_create_protocol_instance_custom_timeframe(self) -> None:
    ...
    def test_create_protocol_instance_only_end_date(self) -> None:
...
@pytest.mark.django_db
class TestCreateConditionWithCoding:
    """Tests for create_condition_with_coding helper."""

    def test_create_condition_with_coding_basic(self) -> None:
    ...
    def test_create_condition_with_coding_custom_onset_date(self) -> None:
    ...
    def test_create_condition_with_coding_arrow_onset_date(self) -> None:
    ...
    def test_create_condition_with_coding_non_surgical(self) -> None:
    ...
    def test_create_condition_with_coding_custom_resolution(self) -> None:
    ...
    def test_create_condition_with_coding_finds_by_valueset(self) -> None:
...
@pytest.mark.django_db
class TestCreateEncounterWithBilling:
    """Tests for create_encounter_with_billing helper."""

    def test_create_encounter_with_billing_basic(self) -> None:
    ...
    def test_create_encounter_with_billing_explicit_cpt(self) -> None:
    ...
    def test_create_encounter_with_billing_default_cpt(self) -> None:
        """Test creating an encounter with default CPT (no ValueSet or code)."""
        patient: Patient = PatientFactory.create()
        encounter_date = arrow.now()

        note, billing = create_encounter_with_billing(
            patient=patient, encounter_date=encounter_date
        )

        assert billing.cpt == "99213"  # Default office visit code

    def test_create_encounter_with_billing_date_object(self) -> None:
    ...
    def test_create_encounter_with_billing_prefers_hcpcs(self) -> None:
    ...
    def test_create_encounter_with_billing_note_date_matches(self) -> None:
...
@pytest.mark.django_db
class TestCreateImagingReportWithCoding:
    """Tests for create_imaging_report_with_coding helper."""

    def test_create_imaging_report_with_coding_basic(self) -> None:
        """Test creating an imaging report with coding from ValueSet."""
        patient: Patient = PatientFactory.create()

        report = create_imaging_report_with_coding(
            patient=patient, value_set_class=MammographyValueSet
        )
    ...
    def test_create_imaging_report_with_coding_custom_dates(self) -> None:
    ...
    def test_create_imaging_report_with_coding_arrow_dates(self) -> None:
    ...
    def test_create_imaging_report_with_coding_finds_by_valueset(self) -> None:
    ...
    def test_create_imaging_report_with_coding_not_found_by_other_valueset(self) -> None:
    ...
    def test_create_imaging_report_with_additional_kwargs(self) -> None:
