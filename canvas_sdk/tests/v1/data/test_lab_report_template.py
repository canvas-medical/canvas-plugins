...
class TestLabReportTemplateQuerySet:
    """Tests for LabReportTemplateQuerySet methods."""

    @pytest.mark.django_db
    def test_active_returns_only_active_templates(self) -> None:
    ...
    @pytest.mark.django_db
    def test_inactive_returns_only_inactive_templates(self) -> None:
    ...
    @pytest.mark.django_db
    def test_point_of_care_returns_poc_templates(self) -> None:
    ...
    @pytest.mark.django_db
    def test_builtin_returns_builtin_templates(self) -> None:
...
class TestLabReportTemplatePrefetch:
    """Tests for prefetch_related support."""
...
class TestFieldType:
    ...
    def test_field_type_values_match_source(self) -> None:
...
class TestLabReportTemplateModel:
    """Tests for LabReportTemplate model."""
...
class TestLabReportTemplateFieldModel:
    """Tests for LabReportTemplateField model."""
    ...
    @pytest.mark.django_db
    def test_field_type_attribute(self) -> None:
...
class TestLabReportTemplateFieldOptionModel:
    """Tests for LabReportTemplateFieldOption model."""
