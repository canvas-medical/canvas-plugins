...
class TestPrefillDocumentFieldsEffectCreation:
    ...
    def test_create_effect_with_top_level_annotations(self) -> None:
    ...
    def test_create_effect_with_multiple_templates(self) -> None:
...
class TestPrefillDocumentFieldsValuesProperty:
...
class TestPrefillDocumentFieldsRequiredFieldValidation:
    ...
    def test_apply_raises_error_when_templates_missing(self) -> None:
    ...
    def test_apply_raises_error_when_templates_empty(self) -> None:
...
class TestPrefillDocumentFieldsDocumentIdValidation:
...
class TestPrefillDocumentFieldsTemplateValidation:
    """Tests for template structure validation."""

    def test_apply_raises_error_when_template_missing_id(self) -> None:
        ...
        assert (
            "templateid" in str(exc_info.value).lower()
            or "template_id" in str(exc_info.value).lower()
        )

    def test_apply_raises_error_when_template_missing_name(self) -> None:
    ...
    def test_apply_raises_error_when_template_name_empty(self) -> None:
...
class TestPrefillDocumentFieldsFieldValidation:
    """Tests for field structure validation."""

    def test_apply_raises_error_when_field_missing_value(self) -> None:
    ...
    def test_apply_succeeds_with_minimal_field(self) -> None:
...
class TestPrefillDocumentFieldsAnnotationValidation:
    ...
    def test_apply_raises_error_when_field_annotation_missing_text(self) -> None:
