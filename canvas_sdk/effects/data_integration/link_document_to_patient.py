...
class LinkDocumentToPatient(_BaseEffect):
    ...
    Attributes:
        ...
        patient_key: The patient's UUID key (required, non-empty string).
        annotations: Optional list of annotation dicts with text and color.
            Example: [{"text": "AI 95%", "color": "#00AA00"}, {"text": "DOB matched"}]
            Each dict must have "text" key, "color" is optional.
