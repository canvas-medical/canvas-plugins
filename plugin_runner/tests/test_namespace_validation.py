...
class TestIsValidNamespaceName:
    ...
    def test_reserved_prefix_pg_rejected(self):
    ...
    def test_valid_namespace_with_double_underscore_accepted(self):
    ...
    def test_namespace_without_double_underscore_rejected(self):
    ...
    def test_namespace_with_single_underscore_rejected(self):
    ...
    def test_namespace_with_only_double_underscore_rejected(self):
    ...
    def test_namespace_with_numbers_accepted(self):
